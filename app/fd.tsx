...
function Fd(){
    ...
    const {imageUrl,nutritionInfo,price,customizationOptions,id ,isAvailable,isPopular,description,name}=item;
...
<View style={{display:'flex',justifyContent:'flex-start'    ,margin:10}}>
    ...
    <View>
      ...
      <View style={{margin:10}}>
        ...
        <Text>isAvalable: {isAvailable}</Text>
        <Text>isPopular: {isPopular}</Text>
      ...
      <View style={{display:'flex',flexDirection:'row', alignItems:'center',backgroundColor:'white',justifyContent:'space-around',margin:8}}>
       <View>
        ...
        <View><Link href={{pathname:'/cart',params:{imageUrl,m,count,price,name}}}>
