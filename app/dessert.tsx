          ...
          <View style={styles.containt}>
            {c.map((x)=>{return(
                     <View style={{margin:10}}>
                      <View >
               <Text style={styles.plat}>Vos differents desserts</Text>
             </View>
                     <TouchableOpacity  >
             ...
             <View><Text style={{ fontSize: 18,textAlign:"center" ,fontWeight:"bold",fontStyle:"italic",fontFamily:"",color:"gray",margin:5}}>Vos gateaux</Text></View>
             <FlatList
  data={x.gateau}
  renderItem={({ item }) => (
    <View
...
/>
                       ...
                       <View><Text style={{ fontSize: 18,textAlign:"center" ,fontWeight:"bold",fontStyle:"italic",fontFamily:"",color:"gray",margin:5}}>Vos fruits</Text></View>
                       <FlatList
  data={x.fruits}
  renderItem={({ item }) => (
    <View
...
/>
                       <View><Text style={{ fontSize: 18,textAlign:"center" ,fontWeight:"bold",fontStyle:"italic",fontFamily:"",color:"gray",margin:5 }}>Vos amuses </Text></View>
                       <FlatList
  data={x.amuse}
  renderItem={({ item }) => (
    <View
