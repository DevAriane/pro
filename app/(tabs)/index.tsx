    ...
    return (
        <SafeAreaView style={styles.area}>
            ...
            <View style={styles.containt}>
                    ...
                    <View >
                    <Foundation name="home" size={24} color="black" borderColor='gray' />
                    <FontAwesome5 name="clipboard-list" size={24} color="black" borderColor='gray' />
                    <AntDesign name="hearto" size={24} color="black" borderColor='gray' />
