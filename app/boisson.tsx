          ...
          <View style={styles.containt}>
            {d.map((x)=>{return(
                     <View style={{margin:10}}>
                       <View >
               <Text style={styles.plat}>Vos differentes boissons</Text>
             </View>
                     <TouchableOpacity  >
             <Image source={x.img} style={{ width: "100%", height: 150, borderColor: 'transparent', borderWidth: 1, borderRadius: 25,margin:5 }} resizeMode="cover" />
               ...
               <View style={{display:'flex',flexDirection:'row',alignItems:'center'}}><Feather name="clock" size={20} color="green" /><Text>20 min</Text></View>
                       ...
                       <View><Text style={{ fontSize: 18,textAlign:"center" ,fontWeight:"bold",fontStyle:"italic",fontFamily:"",color:"gray",margin:5 }}>Vos boissons non alcoolisées</Text></View>
                       <FlatList
  data={x.nonalcool}
  renderItem={({ item }) => (
    <View
